function onclick_details_human_settlement() {
    document.getElementById("id_details_street").open = false;
    document.getElementById("id_details_house").open = false;
    document.getElementById("id_details_entrance").open = false;
    document.getElementById("id_details_apartment").open = false;
    ...
    document.getElementById("id_details_search").open = false;
    document.getElementById("id_details_statistics").open = false;
}

function onclick_details_street() {
    document.getElementById("id_details_human_settlement").open = false;
    document.getElementById("id_details_house").open = false;
    document.getElementById("id_details_entrance").open = false;
    document.getElementById("id_details_apartment").open = false;
    document.getElementById("id_details_route").open = false;
...
function onclick_details_search() {
    document.getElementById("id_details_organization").open = false;
    document.getElementById("id_details_density_population").open = false;
    document.getElementById("id_details_address").open = false;
    document.getElementById("id_details_community_boundary").open = false;
...
function onclick_details_statistics() {
    document.getElementById("id_details_organization").open = false;
    document.getElementById("id_details_density_population").open = false;
    document.getElementById("id_details_address").open = false;
    document.getElementById("id_details_community_boundary").open = false;
