...
function forms_list_search_commands() {
    ...
    data_voice_search_commands_arr.forEach((el) => {
        list_search_parameters += `<button class="button_sidebar_add_map" onclick="determines_type_search_command('${el.name}')">${el.name}</button>`;
    });
    ...
    data_human_settlement_arr.forEach((el) => {
        list_search_parameters += `<button class="button_sidebar_add_map" onclick="determines_type_search_command('${el.human_settlement_name_voice_search}')">${el.human_settlement_name_voice_search}</button>`;
    });
    ...
    data_organization_type_arr.forEach((el) => {
        list_search_parameters += `<button class="button_sidebar_add_map" onclick="determines_type_search_command('${el.organization_type}', 'organization_type')">${el.organization_type}</button>`;
    });
