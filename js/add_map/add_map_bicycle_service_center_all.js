...
function add_map_bicycle_service_center_all() {
    ...
    overlay = new custom_marker(new google.maps.LatLng(Number(organization_arr[0].organization_latitude), Number(organization_arr[0].organization_longitude)), map, {
    ...
    map.panTo(new google.maps.LatLng(Number(organization_arr[0].organization_latitude), Number(organization_arr[0].organization_longitude)));
    map.setZoom(19);
};